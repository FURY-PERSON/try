...
-- -----------------------------------------------------------
-- Feature Flags (2 records)
-- -----------------------------------------------------------
INSERT INTO feature_flags (id, key, name, description, "isEnabled", "createdAt", "updatedAt")
VALUES
  ('clref0001flag0showads0', 'show_ads',         'Показ рекламы',        'Глобальное управление показом рекламы в приложении',                true,  NOW(), NOW()),
  ('clref0002flag0maintena', 'maintenance_mode',  'Режим обслуживания',   'Показывает заглушку вместо контента во время технических работ',    false, NOW(), NOW())
